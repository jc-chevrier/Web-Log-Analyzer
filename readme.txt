...
Installer mailutils : sudo apt-get install mailutils.
  ...
  Ou alors, vous pouvez également utiliser un relais de mail, en installant ssmtp et
  en configurant le relais dans la configuration de ssmtp : etc/ssmtp/ssmtp.conf.
  Cette vidéo décrit comment installer ce genere de relais : https://www.youtube.com/watch?v=qGRSv9PiAkw.
...
Voici un URL pour acheter une clé de l'API en question : https://textbelt.com/purchase/?generateKey=1. 
...
Se rendre dans conf/settings le chemin sur votre machine des logs d'accès et d'erreur d'Apache
sur votre machine : clés access_logs_file_path et error_logs_file_path. Les chemins des logs
varient en fonction des OSs Linux : /var/log/apache2/access.log ou ...,  /var/log/apache2/error.log. 
